...
Variables from AddHealth that will be used include:  H4RD7B (Satisfaction level with the way individuals handle their problems and disagreements), H4RD9 (The level of happiness of individuals in the relationship), H4RD18 (The frequency of physical abuse threats and attempts), and H4RD20 (The frequency of physical injures), H4RD21 (The frequency of non-consensual sexual activities").  ￼
